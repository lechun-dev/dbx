...
import { X, Pin, ChevronDown, Table2, Code2, TableProperties, PencilRuler, KeyRound, Pencil, Package, Lock, Copy, AlertTriangle, Network, Minimize2, Maximize2, Settings, CalendarClock, Activity, Gauge, ListTree } from "@lucide/vue";
                ...
                <TooltipTrigger as-child>
                  ...
                  >
                    <span class="shrink-0" :class="tabIconClass(tab)">
                      ...
                      <ListTree v-else-if="tab.mode === 'objects'" class="h-3.5 w-3.5" />
