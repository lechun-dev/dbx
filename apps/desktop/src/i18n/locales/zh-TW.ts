...
export default withEnglishFallback({
  ...
  grid: {
    ...
    pastedWithTruncation: "已貼上可容納的資料，超出可編輯範圍的內容未貼上。",
    zoomIn: "放大",
    zoomOut: "縮小",
    fitImage: "適合顯示區域",
    openImage: "開啟圖片",
  ...
  ai: {
    ...
    run: "執行",
    readingSchema: "讀取結構",
    databaseScopeCurrent: "目前資料庫",
    databaseScopeCurrentWithName: "目前資料庫：{database}",
    databaseScopeSelected: "選擇多個資料庫",
    databaseScopeSelectedCount: "已選 {count} 個資料庫",
    databaseScopeUnscoped: "不限定資料庫",
    databaseScopeUnscopedHint: "僅一般問答，不讀取資料庫結構",
    databaseScopeNoDatabases: "暫無可選資料庫",
    databaseScopeRequiredForExecution: "請先選擇一個或多個資料庫，再執行 SQL",
    databaseScopeAgentUnavailable: "目前資料庫範圍不支援 Agent 執行",
    ...
    dataDictionaryRefresh: "資料字典重新整理",
    dataDictionaryRefreshDescription: "應用程式執行、資料庫已連線且使用者閒置時，定期核對 AI 已快取的資料字典。",
    dataDictionaryRefreshOff: "關閉",
    dataDictionaryRefreshHours: "每 {hours} 小時",
    dataDictionaryRefreshNow: "立即重新整理",
    dataDictionaryRefreshSaved: "資料字典重新整理週期已儲存",
    dataDictionaryRefreshThrottleHint: "正式環境資料庫的間隔至少為 12 小時，且每輪掃描上限較低。",
    dataDictionaryRefreshComplete: "已重新整理 {dictionaries} 個資料字典：變更或新增 {changed}，刪除 {deleted}，失敗 {failed}。",
    dataDictionaryRefreshNone: "目前已連線的資料庫中沒有可重新整理的資料字典。",
    dataDictionaryRefreshFailed: "資料字典重新整理失敗：{error}",
  ...
  contextMenu: {
    ...
    tableNameFiltersDescription: "先僅顯示符合 include 清單的資料表名稱，再隱藏符合 exclude 清單的資料表名稱。每行一個 SQL LIKE 模式。",
    tableNameFilterInclude: "包含資料表名稱模式",
    tableNameFilterExclude: "排除資料表名稱模式",
  ...
  settings: {
    ...
    dataGridStripeStrength: "隔列底色強度",
    dataGridStripeStrengthDescription: "調整查詢結果相鄰資料列的顏色區分程度，設為 0 可關閉隔列底色。",
    dataGridStripeOff: "關閉",
