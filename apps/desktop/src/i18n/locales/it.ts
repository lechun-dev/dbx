...
export default withEnglishFallback({
  ...
  grid: {
    ...
    pastedWithTruncation: "Sono stati incollati i dati disponibili. Il contenuto fuori dall'intervallo modificabile è stato ignorato.",
    zoomIn: "Ingrandisci",
  ...
  ai: {
    ...
    databaseScopeCurrent: "Database corrente",
    databaseScopeCurrentWithName: "Corrente: {database}",
    databaseScopeSelected: "Seleziona più database",
    databaseScopeSelectedCount: "{count} database selezionati",
    databaseScopeUnscoped: "Nessun database specifico",
    databaseScopeUnscopedHint: "Solo domande generali; non caricare lo schema",
    databaseScopeNoDatabases: "Nessun database disponibile",
    databaseScopeRequiredForExecution: "Seleziona uno o più database prima di eseguire SQL",
    databaseScopeAgentUnavailable: "L'esecuzione Agent non è disponibile per questo ambito",
    ...
    dataDictionaryRefresh: "Aggiornamento dizionario dati",
    dataDictionaryRefreshDescription: "Verifica periodicamente i dizionari dati AI memorizzati nella cache quando l'app è aperta, connessa e inattiva.",
    dataDictionaryRefreshOff: "Disattivato",
    dataDictionaryRefreshHours: "Ogni {hours} ore",
    dataDictionaryRefreshNow: "Aggiorna ora",
    dataDictionaryRefreshSaved: "Pianificazione dell'aggiornamento salvata",
    dataDictionaryRefreshThrottleHint: "I database di produzione usano un intervallo minimo di 12 ore e un limite inferiore per esecuzione.",
    dataDictionaryRefreshComplete: "Aggiornati {dictionaries} dizionari: {changed} modificati o nuovi, {deleted} eliminati, {failed} non riusciti.",
    dataDictionaryRefreshNone: "Nessun dizionario aggiornabile trovato tra i database attualmente connessi.",
    dataDictionaryRefreshFailed: "Aggiornamento del dizionario dati non riuscito: {error}",
  ...
  contextMenu: {
    ...
    tableNameFiltersDescription: "Mostra solo le tabelle che corrispondono alla lista include, poi nasconde quelle che corrispondono alla lista exclude. Un pattern SQL LIKE per riga.",
    tableNameFilterInclude: "Pattern tabelle incluse",
    tableNameFilterExclude: "Pattern tabelle escluse",
  ...
  settings: {
    ...
    dataGridStripeStrength: "Colore righe alternate",
    dataGridStripeStrengthDescription: "Regola il contrasto tra le righe alternate dei risultati. Imposta 0 per disattivarlo.",
    dataGridStripeOff: "Disattivato",
