...
export default withEnglishFallback({
  ...
  grid: {
    ...
    pastedWithTruncation: "Se pegaron los datos que caben. Se omitió el contenido fuera del rango editable.",
    zoomIn: "Acercar",
    zoomOut: "Alejar",
  ...
  ai: {
    ...
    databaseScopeCurrent: "Base de datos actual",
    databaseScopeCurrentWithName: "Actual: {database}",
    databaseScopeSelected: "Seleccionar varias bases de datos",
    databaseScopeSelectedCount: "{count} bases de datos",
    databaseScopeUnscoped: "Sin limitar la base de datos",
    databaseScopeUnscopedHint: "Solo preguntas generales; no cargar el esquema",
    databaseScopeNoDatabases: "No hay bases de datos disponibles",
    databaseScopeRequiredForExecution: "Selecciona una o más bases de datos antes de ejecutar SQL",
    databaseScopeAgentUnavailable: "La ejecución del agente no está disponible para este ámbito",
    ...
    dataDictionaryRefresh: "Actualización del diccionario de datos",
    dataDictionaryRefreshDescription: "Verifica periódicamente los diccionarios de datos de IA en caché cuando la aplicación está abierta, conectada e inactiva.",
    dataDictionaryRefreshOff: "Desactivada",
    dataDictionaryRefreshHours: "Cada {hours} horas",
    dataDictionaryRefreshNow: "Actualizar ahora",
    dataDictionaryRefreshSaved: "Programación de actualización guardada",
    dataDictionaryRefreshThrottleHint: "Las bases de datos de producción usan un intervalo mínimo de 12 horas y un límite menor por ejecución.",
    dataDictionaryRefreshComplete: "Se actualizaron {dictionaries} diccionarios: {changed} cambiados o nuevos, {deleted} eliminados y {failed} fallidos.",
    dataDictionaryRefreshNone: "No se encontraron diccionarios actualizables entre las bases de datos conectadas.",
    dataDictionaryRefreshFailed: "Error al actualizar el diccionario de datos: {error}",
  ...
  settings: {
    ...
    dataGridStripeStrength: "Color de filas alternas",
    dataGridStripeStrengthDescription: "Ajusta el contraste entre filas alternas de resultados. Establécelo en 0 para desactivarlo.",
    dataGridStripeOff: "Desactivado",
