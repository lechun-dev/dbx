export default {
  ...
  grid: {
    ...
    pastedWithTruncation: "Pasted the data that fits. Content outside the editable range was skipped.",
    zoomIn: "Zoom In",
    zoomOut: "Zoom Out",
  ...
  ai: {
    ...
    databaseScopeCurrent: "Current database",
    databaseScopeCurrentWithName: "Current: {database}",
    databaseScopeSelected: "Select multiple databases",
    databaseScopeSelectedCount: "{count} databases selected",
    databaseScopeUnscoped: "No database scope",
    databaseScopeUnscopedHint: "General Q&A only; do not load schema",
    databaseScopeNoDatabases: "No databases available",
    databaseScopeRequiredForExecution: "Select one or more databases before executing SQL",
    databaseScopeAgentUnavailable: "Agent execution is unavailable for this scope. Unscoped chat is Q&A only, and cross-database execution requires one connection with fully qualified table support.",
    ...
    dataDictionaryRefresh: "Data Dictionary Refresh",
    dataDictionaryRefreshDescription: "Periodically verify cached AI data dictionaries while the app is open, connected, and idle.",
    dataDictionaryRefreshOff: "Off",
    dataDictionaryRefreshHours: "Every {hours} hours",
    dataDictionaryRefreshNow: "Refresh now",
    dataDictionaryRefreshSaved: "Data dictionary refresh schedule saved",
    dataDictionaryRefreshThrottleHint: "Production databases use at least a 12-hour interval and a smaller per-run scan limit.",
    dataDictionaryRefreshComplete: "Refreshed {dictionaries} dictionaries: {changed} changed or new, {deleted} deleted, {failed} failed.",
    dataDictionaryRefreshNone: "No refreshable dictionaries were found among currently connected databases.",
    dataDictionaryRefreshFailed: "Data dictionary refresh failed: {error}",
  ...
  contextMenu: {
    ...
    tableNameFiltersDescription: "Show only table names that match the include list, then hide names that match the exclude list. One SQL LIKE pattern per line.",
    tableNameFilterInclude: "Include table patterns",
    tableNameFilterExclude: "Exclude table patterns",
  ...
  settings: {
    ...
    dataGridStripeStrength: "Alternating row color",
    dataGridStripeStrengthDescription: "Adjust the contrast between alternating result rows. Set to 0 to turn it off.",
    dataGridStripeOff: "Off",
