...
export default withEnglishFallback({
  ...
  connection: {
    ...
    kingbaseDatabaseRequired: "Kingbase exige um banco de dados existente antes de conectar ou carregar a lista de bancos de dados.",
  ...
  grid: {
    ...
    pastedWithTruncation: "Os dados que cabem foram colados. O conteúdo fora do intervalo editável foi ignorado.",
    zoomIn: "Aproximar",
    zoomOut: "Afastar",
  ...
  ai: {
    ...
    databaseScopeCurrent: "Banco de dados atual",
    databaseScopeCurrentWithName: "Atual: {database}",
    databaseScopeSelected: "Selecionar vários bancos",
    databaseScopeSelectedCount: "{count} bancos selecionados",
    databaseScopeUnscoped: "Sem limitar o banco",
    databaseScopeUnscopedHint: "Apenas perguntas gerais; não carregar schema",
    databaseScopeNoDatabases: "Nenhum banco disponível",
    databaseScopeRequiredForExecution: "Selecione um ou mais bancos antes de executar SQL",
    databaseScopeAgentUnavailable: "A execução do agente não está disponível para este escopo",
    ...
    dataDictionaryRefresh: "Atualização do dicionário de dados",
    dataDictionaryRefreshDescription: "Verifica periodicamente os dicionários de dados de IA em cache quando o aplicativo está aberto, conectado e ocioso.",
    dataDictionaryRefreshOff: "Desativada",
    dataDictionaryRefreshHours: "A cada {hours} horas",
    dataDictionaryRefreshNow: "Atualizar agora",
    dataDictionaryRefreshSaved: "Agenda de atualização salva",
    dataDictionaryRefreshThrottleHint: "Bancos de produção usam intervalo mínimo de 12 horas e limite menor por execução.",
    dataDictionaryRefreshComplete: "{dictionaries} dicionários atualizados: {changed} alterados ou novos, {deleted} excluídos e {failed} com falha.",
    dataDictionaryRefreshNone: "Nenhum dicionário atualizável foi encontrado entre os bancos conectados.",
    dataDictionaryRefreshFailed: "Falha ao atualizar o dicionário de dados: {error}",
  ...
  contextMenu: {
    ...
    tableNameFiltersDescription: "Mostra apenas tabelas que correspondem à lista include e oculta as que correspondem à lista exclude. Um padrão SQL LIKE por linha.",
    tableNameFilterInclude: "Padrões de tabelas incluídas",
    tableNameFilterExclude: "Padrões de tabelas excluídas",
  ...
  settings: {
    ...
    dataGridStripeStrength: "Cor de linhas alternadas",
    dataGridStripeStrengthDescription: "Ajuste o contraste entre as linhas alternadas dos resultados. Defina como 0 para desativar.",
    dataGridStripeOff: "Desativado",
