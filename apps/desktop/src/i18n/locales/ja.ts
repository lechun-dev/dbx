...
export default withEnglishFallback({
  ...
  grid: {
    ...
    pastedWithTruncation: "収まるデータを貼り付けました。編集可能な範囲外の内容はスキップされました。",
    zoomIn: "拡大",
    zoomOut: "縮小",
    fitImage: "表示領域に合わせる",
    openImage: "画像を開く",
  ...
  ai: {
    ...
    databaseScopeCurrent: "現在のデータベース",
    databaseScopeCurrentWithName: "現在：{database}",
    databaseScopeSelected: "複数のデータベースを選択",
    databaseScopeSelectedCount: "{count}個のデータベース",
    databaseScopeUnscoped: "データベースを限定しない",
    databaseScopeUnscopedHint: "一般的な質問のみ（スキーマは読み込みません）",
    databaseScopeNoDatabases: "選択可能なデータベースがありません",
    databaseScopeRequiredForExecution: "SQLを実行する前にデータベースを選択してください",
    databaseScopeAgentUnavailable: "このデータベース範囲ではAgent実行を使用できません",
    ...
    dataDictionaryRefresh: "データ辞書の更新",
    dataDictionaryRefreshDescription: "アプリが起動中・接続済み・アイドル状態のとき、キャッシュ済みAIデータ辞書を定期的に確認します。",
    dataDictionaryRefreshOff: "オフ",
    dataDictionaryRefreshHours: "{hours}時間ごと",
    dataDictionaryRefreshNow: "今すぐ更新",
    dataDictionaryRefreshSaved: "データ辞書の更新間隔を保存しました",
    dataDictionaryRefreshThrottleHint: "本番データベースでは最短12時間間隔と、より小さい1回あたりのスキャン上限を使用します。",
    dataDictionaryRefreshComplete: "{dictionaries}個の辞書を更新しました：変更または新規 {changed}、削除 {deleted}、失敗 {failed}。",
    dataDictionaryRefreshNone: "現在接続中のデータベースに更新可能な辞書はありません。",
    dataDictionaryRefreshFailed: "データ辞書の更新に失敗しました：{error}",
  ...
  settings: {
    ...
    dataGridStripeStrength: "交互行の背景色",
    dataGridStripeStrengthDescription: "結果の交互行のコントラストを調整します。0 にすると無効になります。",
    dataGridStripeOff: "オフ",
