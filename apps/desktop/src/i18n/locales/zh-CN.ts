...
export default withEnglishFallback({
  ...
  grid: {
    ...
    pastedWithTruncation: "已粘贴可容纳的数据，超出可编辑范围的内容未粘贴。",
    zoomIn: "放大",
    zoomOut: "缩小",
    fitImage: "适合显示区域",
    openImage: "打开图片",
  ...
  ai: {
    ...
    run: "执行",
    readingSchema: "读取结构",
    databaseScopeCurrent: "当前库",
    databaseScopeCurrentWithName: "当前库：{database}",
    databaseScopeSelected: "选择多个库",
    databaseScopeSelectedCount: "已选 {count} 个库",
    databaseScopeUnscoped: "不限定数据库",
    databaseScopeUnscopedHint: "仅普通问答，不读取库结构",
    databaseScopeNoDatabases: "暂无可选数据库",
    databaseScopeRequiredForExecution: "请先选择一个或多个数据库，再执行 SQL",
    databaseScopeAgentUnavailable: "当前数据库范围不支持 Agent 执行；未选库仅支持问答，跨库执行需使用支持完整表名的同一连接",
    ...
    dataDictionaryRefresh: "数据字典刷新",
    dataDictionaryRefreshDescription: "应用运行、数据库已连接且用户空闲时，定期核对 AI 已缓存的数据字典。",
    dataDictionaryRefreshOff: "关闭",
    dataDictionaryRefreshHours: "每 {hours} 小时",
    dataDictionaryRefreshNow: "立即刷新",
    dataDictionaryRefreshSaved: "数据字典刷新周期已保存",
    dataDictionaryRefreshThrottleHint: "生产库刷新间隔至少 12 小时，并采用更低的单轮扫描上限。",
    dataDictionaryRefreshComplete: "已刷新 {dictionaries} 个数据字典：变化或新增 {changed}，删除 {deleted}，失败 {failed}。",
    dataDictionaryRefreshNone: "当前已连接的数据库中没有可刷新的数据字典。",
    dataDictionaryRefreshFailed: "数据字典刷新失败：{error}",
  ...
  settings: {
    ...
    dataGridStripeStrength: "隔行底色强度",
    dataGridStripeStrengthDescription: "调整查询结果相邻行的颜色区分程度，设为 0 可关闭隔行底色。",
    dataGridStripeOff: "关闭",
